        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-6 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Visi pieteikumi un klienti</h1>
          ...
          <div className="grid grid-cols-4 gap-4 mb-6">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
              <p className="text-2xl font-bold text-orange-600">{sampleLeads.filter(l => l.status === 'prospect').length}</p>
              <p className="text-sm text-gray-600">Pieteikumi</p>
            </div>
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
              <p className="text-2xl font-bold text-yellow-600">{sampleLeads.filter(l => l.status === 'lead').length}</p>
              <p className="text-sm text-gray-600">Klienti</p>
            </div>
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
              <p className="text-2xl font-bold text-green-600">{sampleLeads.filter(l => l.status === 'agreement').length}</p>
              <p className="text-sm text-gray-600">Līgumi</p>
            </div>
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
              <p className="text-2xl font-bold text-blue-600">{sampleLeads.filter(l => l.status === 'queue').length}</p>
              <p className="text-sm text-gray-600">Rindā</p>
            </div>
          </div>
              ...
              <tbody className="divide-y divide-gray-100">
                {sampleLeads.map((lead) => (
                  <tr
                    ...
                    onClick={() => {
                      // Set the lead data and navigate to appropriate view
                      setSavedLead({
                        ...lead,
