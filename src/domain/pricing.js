...
export const PRICING_TABLE = {
  melodija: {
    long: {
      triple: { 1: 43, 2: 46, 3: 52, 4: 57 },  // Placeholder - needs actual pricing
      double: { 1: 48, 2: 51, 3: 58, 4: 63 },
      single: { 1: 65, 2: 70, 3: 77, 4: 87 }
    },
    short: {
      triple: { 1: 46, 2: 49, 3: 57, 4: 61 },  // Placeholder - needs actual pricing
  ...
  sampeteris: {
    long: {
      triple: { 1: 46, 2: 49, 3: 56, 4: 61 },  // Placeholder - needs actual pricing
      double: { 1: 51, 2: 55, 3: 62, 4: 67 },
      single: { 1: 69, 2: 74, 3: 82, 4: 94 }
    },
    short: {
      triple: { 1: 49, 2: 52, 3: 60, 4: 64 },  // Placeholder - needs actual pricing
 ...
 * @param {string} params.roomType - Room type ('single', 'double', or 'triple')
